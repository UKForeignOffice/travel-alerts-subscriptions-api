...
CREATE TABLE "Subscription" (
    ...
    "recipientIdPrefix" TEXT NOT NULL,
    "isRecipientIdVerified" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateTable
CREATE TABLE "SubscriberSubscription" (
...
-- AddForeignKey
ALTER TABLE "SubscriberSubscription" ADD FOREIGN KEY ("subscriberId") REFERENCES "Subscriber"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SubscriberSubscription" ADD FOREIGN KEY ("subscriptionId") REFERENCES "Subscription"("id") ON DELETE CASCADE ON UPDATE CASCADE;
